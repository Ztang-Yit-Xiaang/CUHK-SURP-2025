...
def pose_estimate(cfg):
    ...
    # 1-载入传感器采集的数据
    train_dataset = MagneticDatasetSeq(dir_path=cfg.dataset_dir, file_name=cfg.key_word)
    ...
    init_mag_prop = np.array([-0.075, 0.075, 0.06, 0, 0, 1, 2.37e-08, 0, 0, 0])
...
def args_cfg():
    ...
    parser.add_argument('--key_word', type=str, default="save_sequ_301920.txt")
...
if __name__ == "__main__":
    ...
    save_file_name = cfg.key_word.replace("save", "fix_pose")
