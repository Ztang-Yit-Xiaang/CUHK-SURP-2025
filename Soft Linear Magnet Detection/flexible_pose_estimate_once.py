...
def fun_dipole_model(init_mag_prop, sensor_data):
    ...
    # 预测环形传感器阵列的位置和方向
    beta1, beta2 = init_mag_prop[10:16], init_mag_prop[16:22]
...
def pose_estimate(cfg):
    ...
    for data_sensor, data_prop in train_loader:
        ...
        # 初始估计值
        beta1 = np.array([45.0,  60.0,  90.0,  120.0, 150, 180], dtype=np.double)
        beta2 = np.array([-45.0,  -60.0, -90.0, -120.0, -150, -180], dtype=np.double)
        ...
        print("Beta1: ", est_mag_prop[10:16])
        print("Beta2: ", est_mag_prop[16:])
...
def args_cfg():
    ...
    parser.add_argument('--key_word', type=str, default="data_once_120815_l1")
